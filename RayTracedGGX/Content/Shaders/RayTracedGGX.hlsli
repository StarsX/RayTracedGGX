...
//--------------------------------------------------------------------------------------
float3 computeLocalDirectionGGX(float a)
{
	const float2 xi = l_hitGroupCB.Hammersley;
...
float3 computeDirectionGGX(float a, float3 normal)
{
	const float3 localDir = computeLocalDirectionGGX(a);
